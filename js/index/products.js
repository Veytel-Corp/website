const productBtnsManager = {
    productsPageURL: window.location.href.includes('staging') ? '/staging/products.html' : '/products.html',
    targetProduct: '',
}
...
const requestDemoFormManager = {
    ...
    requestURL: 'https://script.google.com/macros/s/AKfycby22ij9ioLxPK8tXGpKyJy5j_eqDyXHpoDZPVpLMv7XtRvT7WjqZ88sY_Uyw539Ygzl/exec',
    targetProduct: '',
    formData: null,
}
...
requestDemoFormManager.setFormData = () => {
    ...
    formData.set("message", `I would like to know more about the product ${targetProduct}.`);
...
requestDemoFormManager.initCloseRequestDemoModalBtn = () => {
    const closeRequestDemoModalEl = document.querySelectorAll('.close-request-demo-modal');
